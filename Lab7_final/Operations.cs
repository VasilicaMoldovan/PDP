...
namespace Lab7_final
{
    class Operations
    {
        public static Polynomial MPI_multiply(Polynomial polynomial1, Polynomial polynomial2, int begin, int end)
        {
            Polynomial result;
        ...
        public static Polynomial asynchronous_karatsuba_multiply(Polynomial p1, Polynomial p2)
        {
            Polynomial result = new Polynomial(p1.Degree + p2.Degree);
            result.Coefficients = asynchronous_karatsuba_multiply_recursive(p1.Coefficients, p2.Coefficients);

            return result;
        }

        public static int[] asynchronous_karatsuba_multiply_recursive(int[] coefficients1, int[] coefficients2)
        {

            int[] product = new int[2 * coefficients1.Length];

            //The polynomial has only one coefficient
            ...
            {
                return asynchronous_karatsuba_multiply_recursive(coefficients1Low, coefficients2Low);
            });

            Task<int[]> t2 = Task<int[]>.Factory.StartNew(() =>
            {
                return asynchronous_karatsuba_multiply_recursive(coefficients1High, coefficients2High);
            });

            Task<int[]> t3 = Task<int[]>.Factory.StartNew(() =>
            {
                return asynchronous_karatsuba_multiply_recursive(coefficients1LowHigh, coefficients2LowHigh);
            });
        ...
        public static void MPI_karatsuba_multiply()
        {
